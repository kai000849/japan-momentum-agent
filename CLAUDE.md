...
| 朝 6:30 | morning-scan | `30 21 * * 0-5` | 日本株スキャン＋保有状況通知。us-market-scanと並行実行。 |
| 前場 10:30 | midmorning-scan | `30 1 * * 1-5` | ザラ場決算モメンタムスキャン（前日決算銘柄の寄り付き反応確認）。 |
| 正午 12:15 | noon-scan | `15 3 * * 1-5` | 後場エントリー判断（yfinance前場データで朝シグナル銘柄の維持確認）。 |
| 夕方 18:00 | evening-scan | `0 9 * * 1-5` | メイン通知。シグナル＋保有状況＋決算引け後評価＋フォローアップ。 |
...
- 5ジョブ構成（朝6:30×2・前場10:30・正午12:15・夕方18:00）で稼働中
